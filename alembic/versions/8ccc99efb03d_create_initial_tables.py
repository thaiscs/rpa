...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("encrypted_pfx", sa.JSON(), nullable=False),
        sa.Column("encrypted_pfx_password", sa.JSON(), nullable=False),
        sa.Column("encrypted_cert", sa.JSON(), nullable=False),
        sa.Column("encrypted_key", sa.JSON(), nullable=False),
